...
| `PUSH0`                                                                                                                                                  | -                   | Currently not supported by the                                                                                                                                                                                                                          |
| OP Stack. Support to be introduced as part of the [Canyon hardfork](https://web.archive.org/web/20231207231718/https://blog.oplabs.co/canyon-hardfork/). |                     |                                                                                                                                                                                                                                                         |
